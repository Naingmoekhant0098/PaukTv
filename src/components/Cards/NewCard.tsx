...
export default function FootballNewsCard({item} : any) {
  ...
  return (
      ...
      <div className="bg-white/5 rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 group shadow-lg border border-white/5">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-500">
            ...
            <div  className=" border p-1.5 px-4  flex flex-row items-center rounded-full  text-center  border-gray-400 text-gray-300 text-[12px] transition-all duration-500 cursor-pointer hover:border-[#F65311] hover:bg-[#F65311] ">
         Read More <div>
